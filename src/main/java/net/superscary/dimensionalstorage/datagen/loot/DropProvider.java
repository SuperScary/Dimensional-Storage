package net.superscary.dimensionalstorage.datagen.loot;
...
public class DropProvider extends BlockLootSubProvider {
    ...
    private ImmutableMap<Block, Function<Block, LootTable.Builder>> createOverrides() {
        return ImmutableMap.<Block, Function<Block, LootTable.Builder>>builder()
                .put(DSBlocks.DRAKIUM_ORE.block(), oreBlock(DSBlocks.DRAKIUM_ORE.block(), DSItems.RAW_DRAKIUM_ORE.asItem()))
                .put(DSBlocks.DEEPSLATE_DRAKIUM_ORE.block(), oreBlock(DSBlocks.DEEPSLATE_DRAKIUM_ORE.block(), DSItems.RAW_DRAKIUM_ORE.asItem()))
                .put(DSBlocks.END_STONE_DRAKIUM_ORE.block(), oreBlock(DSBlocks.END_STONE_DRAKIUM_ORE.block(), DSItems.RAW_DRAKIUM_ORE.asItem()))
                .put(DSBlocks.NETHER_DRAKIUM_ORE.block(), oreBlock(DSBlocks.NETHER_DRAKIUM_ORE.block(), DSItems.DRAKIUM_NUGGET.asItem()))
                .build();
    }
    ...
    protected @NotNull Iterable<Block> getKnownBlocks() {
        return BuiltInRegistries.BLOCK.stream().filter(entry -> entry.getLootTable().location().getNamespace().equals(DimensionalStorage.MODID))
                .toList();
    }
