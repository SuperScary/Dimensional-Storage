...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap (BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldDrakiumOres = List.of(OreConfiguration.target(stoneReplaceables, DSBlocks.DRAKIUM_ORE.block().defaultBlockState()), OreConfiguration.target(deepslateReplaceables, DSBlocks.DEEPSLATE_DRAKIUM_ORE.block().defaultBlockState()));
        List<OreConfiguration.TargetBlockState> endDrakiumOres = List.of(OreConfiguration.target(endReplaceables, DSBlocks.END_STONE_DRAKIUM_ORE.block().defaultBlockState()));
        List<OreConfiguration.TargetBlockState> netherDrakiumOres = List.of(OreConfiguration.target(netherReplaceables, DSBlocks.NETHER_DRAKIUM_ORE.block().defaultBlockState()));
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey (String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, DimensionalStorage.getResource(name));
    }
